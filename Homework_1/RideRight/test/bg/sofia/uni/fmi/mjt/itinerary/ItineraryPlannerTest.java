...
public class ItineraryPlannerTest {
    ...
    @Test
    public void testNoJourneys() throws CityNotKnownException, NoPathToDestinationException {
        City a = new City("A", new Location(-6, 2));
        City b = new City("B", new Location(4, 2));
        City c = new City("C", new Location(2, -4));
        ...
        assertEquals(
                List.of(), planner.findCheapestPath(a, a, true));

        assertEquals(
                List.of(), planner.findCheapestPath(b, b, false));
    }
